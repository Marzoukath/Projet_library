...
function create_account() {
    try 
    {
        ...
        $sth = $db->prepare("INSERT INTO Teachers (fullname, email, mobile, password, matricule, speciality, domain, grade, created_at) VALUES(:nm, :email, :phone, :mdp, :mat, :spe, :domain, :grad, :created_at)");
