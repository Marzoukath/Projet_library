...
<body>
    <div class="page-wrapper">
      <img src="image/logo_black.png" alt="Your Logo" class="logo">
        <form id="" action="update_profile.php" method="post" class="card">
            ...
            <div class="card-body">
                <div class="mb-3">
                    ...
                    <input class="form-control" name= "fullname" type="text" value="<?php echo $_SESSION['fullname'];?>">
                </div>
                <div class="mb-3">
                    <label class="form-label">Matricule</label>
                    <input class="form-control"  name="matricule"type="text" value="<?php echo $_SESSION['matricule'];?>">
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input class="form-control" name="mobile"type="text" value="<?php echo $_SESSION['mobile'];?>">
                </div>
                <div class="mb-3">
                    <label class="form-label">Filière</label>
                    <input class="form-control" name="filiere" type="text" value="<?php echo $_SESSION['filiere'];?>">
                </div>
                <div class="mb-3">
                    <label class="form-label">Compte crée le</label>
                    <input class="form-control" name="created_at" type="text" value="<?php echo $_SESSION['created_at'];?>">
                </div>
            </div>
